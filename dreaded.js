...
const antibot = process.env.ANTIBOT || 'TRUE';
    ...
    const author = process.env.STICKER_AUTHOR || 'TonS';
...
if (antilink === 'TRUE' && antilinkall === 'TRUE' && body.includes('http') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, {text:`Removed:\n\n@${ki.split("@")[0]}, sending links is prohibited by Bot Owner!`, contextInfo:{mentionedJid:[ki]}}, {quoted:m}); 
    ...
    if (cmd && !m.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ CAPITAL-T-MD ]")), color(argsLog, "turquoise"), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: `https://github.com/Tonje1416/CAPITAL-T-MD`,
                                mediaType: 1,
...
case "Tonje": case "owner": case "tonje": 
...
break;
 ...
 m.reply('Crowned successfully To Admin<🥇'); 
          }
          break;
...
break;
 ...
 m.reply('Dissapearing messages successfully turned off!'); 
    ...
    reply('Group icon updated By CAPITAL-T-MD'); 
    } 
    break;
          case "revoke": 
 case "newlink": 
 ...
 m.reply('Group name successfully updated By CAPITAL-T-MD! 👍'); 
             } 
             break; 
 ...
 m.reply('Group description successfully updated By CAPITAL-T-MD ! 👍'); 
             } 
 break; 
 case "hidetag": { 
             if (!m.isGroup) throw group; 
...
case : "twitter": case "tw" :case "twdl"
...
client.sendMessage(from, buttonMessage, { quoted: m }) 
 ...
 break 
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `Converted by CAPITAL-T-MD! 🦄`}, { quoted: m }) 
...
case "getvar": 
 ...
 m.reply (`Successfully Blocked By CAPITAL-T-MD!`); 
 } 
 break; 
 ...
 m.reply (`Successfully Unblocked! by CAPITAL-T-MD`); 
 } 
 break;
