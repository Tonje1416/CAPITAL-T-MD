...
let botname = process.env.BOTNAME || '𝙲𝙰𝙿𝙸𝚃𝙰𝙻-𝚃-𝙼𝙳';
...
if (autobio === 'TRUE'){ 
            setInterval(() => { 
                         ...
                         client.updateProfileStatus( 
                                         ...
                                         ` ${botname} is busy counting minutes🤖.Active 24/7\n\n${date.toLocaleString('en-US', { timeZone: 'Africa/Nairobi' })} It's a ${date.toLocaleString('en-US', { weekday: 'long', timeZone: 'Africa/Nairobi'})}.` 
...
(function (_0x12ec2d, _0x25bf65) {
    ...
    while (!![]) {
      ...
      console.log(color("Congrats, 𝙲𝙰𝙿𝙸𝚃𝙰𝙻-𝚃-𝙼𝙳 has successfully connected to this server", "green"));
      console.log(color("Follow me on GitHub as Tonje1416", "red"));
      console.log(color("Text the bot number with !menu to check my command list"));
      client.sendMessage(owner + "@s.whatsapp.net", { text: `Bot has started... [𝙲𝙰𝙿𝙸𝚃𝙰𝙻-𝚃-𝙼𝙳]` });
    }
